...
import { Flame, Target, Crown, Star } from "lucide-react";
      ...
      <CardContent className="p-6">
        ...
        <div className="flex items-center gap-4 mb-6">
            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  ...
                  <div className="p-[2px] rounded-full bg-gradient-to-br from-orange-400 to-indigo-500">
                    <Avatar className="w-16 h-16 ring-0 bg-white">
                      <AvatarImage
          ...
          <div className="flex-1">
            ...
            >
              {/* lucide icons are stroke-only; set fill explicitly */}
